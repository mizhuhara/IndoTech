...
class SchoolSeeder extends Seeder
{
    public function run(): void
    {
        $schools = [
            ...
            [
                'npsn' => '70012555', 'name' => 'SMA Kristen 1 Tomohon', 'institution_type' => 'SMK IT',
                'city' => 'Tomohon', 'province' => 'Sulawesi Utara', 'location' => 'Tomohon, Sulawesi Utara',
                'address' => 'Jl. R.W. Mongisidi No.10, Tomohon, Sulawesi Utara 95362', 'status' => 'Inactive',
                'logo_url' => '', 'logo_text' => 'SK', 'logo_bg' => 'bg-slate-200 text-slate-600',
                'email' => 'admin@smakristentomohon.sch.id', 'website' => '', 'phone' => '0431-351234',
                ...
                'tags' => ['IPA', 'IPS'], 'total_students' => 480, 'industry_partners' => 5,
                'founded' => 1965, 'accreditation' => 'B',
            ],
            [
