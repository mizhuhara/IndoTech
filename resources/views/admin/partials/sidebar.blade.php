    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        @php
            $menu = [
                ...
                ['label' => 'User and Verification', 'icon' => 'users', 'active' => request()->routeIs('admin.users.*'), 'href' => route('admin.users.index'), 'arrow' => true],
                ['label' => 'School', 'icon' => 'school', 'active' => request()->routeIs('admin.schools.*'), 'href' => route('admin.schools.index')],
