...
@section('title', 'Add New Company — IndoTech')

@section('content')
<form method="POST" action="{{ route('admin.company.store') }}" class="space-y-6 max-w-7xl mx-auto">
    @csrf
        ...
        <div class="lg:col-span-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {{-- Company Name --}}
                    <div>
                        <label class="block text-[13px] font-semibold text-slate-700 mb-2">Company Name</label>
                        <input type="text" 
                               name="name" 
                               value="{{ old('name') }}" 
                               required
                    ...
                    {{-- Company Code --}}
                    <div>
                        <label class="block text-[13px] font-semibold text-slate-700 mb-2">Company Code</label>
                        <input type="text" 
                               name="npsn" 
                               value="{{ old('npsn') }}" 
                               required
                    ...
                    {{-- Company Type --}}
                    <div>
                        <label class="block text-[13px] font-semibold text-slate-700 mb-2">Company Type</label>
                        <div class="relative">
                            <select name="type" 
                    ...
                    {{-- Industry --}}
                    <div>
                        <label class="block text-[13px] font-semibold text-slate-700 mb-2">Industry</label>
                        <input type="text" 
                               name="industry" 
                               value="{{ old('industry') }}" 
                               required
                    ...
                    {{-- City --}}
                    <div>
                        <label class="block text-[13px] font-semibold text-slate-700 mb-2">City</label>
                        <input type="text" 
                               name="city" 
                               value="{{ old('city') }}" 
                               required
                    ...
                    {{-- Province --}}
                    <div>
                        <label class="block text-[13px] font-semibold text-slate-700 mb-2">Province</label>
                        <input type="text" 
                               name="province" 
                               value="{{ old('province') }}" 
                               required
