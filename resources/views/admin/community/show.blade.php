...
@section('header_title', $community['name'] ?? 'Community Details')
@section('header_breadcrumb', 'Detail Komunitas')
@section('header_subtitle', 'Informasi forum kolaborasi dan ruang diskusi komunitas')
...
<div class="space-y-6 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <a href="{{ route('admin.community.index') }}" class="inline-flex items-center gap-2 text-[14px] font-semibold text-slate-700 hover:text-blue-600 transition">
