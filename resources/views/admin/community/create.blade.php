...
@section('title', 'Add New Community — IndoTech')

@section('content')
<form method="POST" action="{{ route('admin.community.store') }}" class="space-y-6 max-w-7xl mx-auto">
    @csrf
    ...
    <div>
        ...
        <div class="text-[13px] text-slate-500 mb-1 flex items-center gap-1.5 font-medium">
            ...
            <span class="text-slate-900 font-semibold">Add New Community</span>
        </div>

        <h1 class="text-[26px] font-bold text-slate-900 tracking-tight">Add New Community</h1>
    </div>
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs flex flex-col items-center text-center">
                ...
                <div class="w-full aspect-[4/3] rounded-2xl bg-[#f0f4f9] border border-slate-200/70 flex items-center justify-center p-6 mb-4 relative overflow-hidden">
                    <div class="w-24 h-24 rounded-full bg-blue-50 flex items-center justify-center text-[#0b57d0] font-extrabold text-xl shadow-sm border border-white">
