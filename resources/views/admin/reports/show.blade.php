...
@section('title', 'Report Information — IndoTech Admin')
...
<div class="space-y-6 max-w-6xl">
    <div class="flex items-center justify-end">
        <a href="{{ route('admin.reports.index') }}" class="h-9 px-4 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white text-[13px] font-semibold text-slate-700 hover:bg-slate-50 transition shadow-2xs">
    ...
    @if (! $report)
        <div class="bg-white rounded-2xl border border-slate-200 p-8 text-center text-[14px] text-slate-500 shadow-xs">
    ...
    @else
        ...
        <section class="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
            ...
            <div class="px-6 py-5">
                <h2 class="text-[18px] font-bold text-slate-900">{{ $report['title'] }}</h2>
                ...
                <section class="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="note" rows="3" class="mt-2 w-full rounded-xl border border-slate-200 px-3 py-2 text-[13px] text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500" placeholder="Tulis catatan untuk laporan ini..."></textarea>
                        </div>

                        <div class="flex gap-2">
                            <button class="flex-1 h-9 inline-flex items-center justify-center rounded-xl bg-[#0b57d0] text-white text-[13px] font-semibold hover:bg-blue-700 transition">Simpan</button>
                            <button class="h-9 px-4 inline-flex items-center justify-center rounded-xl border border-slate-200 text-slate-600 text-[13px] font-semibold hover:bg-slate-50 transition">Batal</button>
                        </div>
                    </div>
                </section>
