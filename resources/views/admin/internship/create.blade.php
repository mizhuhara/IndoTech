...
@section('title', 'Post New Internship — Admin IndoTech')
...
<form action="{{ route('admin.internships.store') }}" method="POST" class="space-y-6">
    ...
    <div class="text-[13px] text-slate-500 flex items-center gap-2">
        ...
        <span>›</span>
        <span class="text-slate-900 font-semibold">Post New Internship</span>
    </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-[24px] font-bold text-slate-900 tracking-tight">Post New Internship</h1>
        </div>

        <div class="flex items-center gap-3">
            <a href="{{ route('admin.internships.index') }}" class="inline-flex items-center justify-center bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold px-5 py-2.5 rounded-lg text-[13.5px] transition">
                Batal
            </a>
            <button type="submit" class="inline-flex items-center justify-center gap-2 bg-[#0b57d0] hover:bg-blue-700 text-white font-semibold px-5 py-2.5 rounded-lg text-[13.5px] shadow-2xs transition">
                ...
                <span>Publikasikan Internship</span>
            </button>
        </div>
    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-2xs space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" placeholder="mis. Full Stack Developer Intern" required
                    ...
                    <div>
                        ...
                        <input type="text" name="salary_range" placeholder="mis. 4.000.000 - 6.000.000"
                               class="w-full bg-slate-100/70 border border-slate-200 rounded-xl px-4 py-2.5 text-[13.5px] text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-2xs space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="6" required id="desc-field" placeholder="Tuliskan deskripsi lengkap program magang..."
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-2xs space-y-4">
                ...
                <div>
                    ...
                    <textarea name="requirements" rows="6" placeholder="- Mahasiswa semester akhir / Fresh Graduate...&#10;- Paham dasar React, Python, atau Go..."
                              class="w-full bg-slate-100/70 border border-slate-200 rounded-xl p-4 text-[13.5px] text-slate-900 leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-2xs space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="company" placeholder="mis. Gojek Tech" required
                           class="w-full bg-slate-100/70 border border-slate-200 rounded-xl px-4 py-2.5 text-[13.5px] text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition">
                </div>
